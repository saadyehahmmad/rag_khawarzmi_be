"""
Hybrid retrieval (dense Chroma + lexical BM25) with optional cross-encoder re-ranking.
...
RERANK_POOL = max(1, int(os.getenv("RERANK_POOL", "16")))
RERANK_MAX_CHARS = max(256, int(os.getenv("RERANK_MAX_CHARS", "1024")))
...
def hybrid_retrieve(
    ...
    *,
    ...
    Merging the distance measurement into this call avoids a second round-trip to Chroma.
